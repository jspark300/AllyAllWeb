...
$sql = "select id,name,cate,cate_sub,img1,img_id,order_tel_st,order_sms_st,regular_count,eva_point ".$dist." from t_comp ".$where." order by ".$dist_sort." limit  $start, 10";
//echo $sql;
$res = sql_query($sql);
$i=0;
