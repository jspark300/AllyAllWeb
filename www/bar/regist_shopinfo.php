...
?>					
			...
			<li>
				...
				<div class="input">
					<p><input type="text" name="bungi" placeholder="예)123 강남빌딩1층" value="<?=$add_detail?>"></p><a href="javascript:get_map_open(reg_com.company.value,sido.value,gugun.value,dong.value,reg_com.bungi.value);">지도보기</a>
				</div>
