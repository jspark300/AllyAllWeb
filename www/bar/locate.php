...
<script type="text/javascript" src="//apis.daum.net/maps/maps3.js?apikey=42899ae4ee62e4290b4d3ca3842c4bde&libraries=services"></script>
...
{
	document.getElementById('location').innerHTML = 'GPS를 실행해 주세요.';
}
...
function deleteCookie(){
        ...
        if(typeof cDay != 'undefined') cookies += ';expires=' + expire.toGMTString() + ';';
        document.cookie = cookies;
		document.getElementById('location').innerHTML = '선택지역 : 없음';
}
...
?>
	...
	<section class="search">
		<div class="btn_wrap align_right"><a href="javascript:getLocation();">현재 위치로 설정</a> <a href="javascript:deleteLocation();">위치삭제</a></div>
