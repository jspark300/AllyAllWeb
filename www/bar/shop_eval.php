...
?>
	...
	<section class="shop_eval">
		...
		<h2>평가하기</h2>
		<div class="d1">
			<span>평가 보상</span> <strong>응모권1개 지급</strong> (1일 최대 10개까지 지급)
		</div>
		<div class="d2">
			...
			<ul>
				<li>
					<p>맛집</p>
					<p class="eval_rating">
					    <a class="e1" onclick="javascript:seteva(1,1);" ></a>
					    <a class="e2" onclick="javascript:seteva(1,2);"></a>
					    <a class="e3" onclick="javascript:seteva(1,3);"></a>
					    <a class="e4" onclick="javascript:seteva(1,4);"></a>
					    <a class="e5 on" onclick="javascript:seteva(1,5);"></a>
					</p>
				</li>
				<li>
					<p>신속</p>
					<p class="eval_rating">
					    <a class="e1" onclick="javascript:seteva(2,1);"></a>
					    <a class="e2" onclick="javascript:seteva(2,2);"></a>
					    <a class="e3" onclick="javascript:seteva(2,3);"></a>
					    <a class="e4" onclick="javascript:seteva(2,4);"></a>
					    <a class="e5 on" onclick="javascript:seteva(2,5);"></a>
					</p>
				</li>
				<li>
					<p>친절</p>
					<p class="eval_rating">
					    <a class="e1" onclick="javascript:seteva(3,1);"></a>
					    <a class="e2" onclick="javascript:seteva(3,2);"></a>
					    <a class="e3" onclick="javascript:seteva(3,3);"></a>
					    <a class="e4" onclick="javascript:seteva(3,4);"></a>
					    <a class="e5 on" onclick="javascript:seteva(3,5);"></a>
					</p>
				</li>
				<li>
					<p>청결</p>
					<p class="eval_rating">
					    <a class="e1" onclick="javascript:seteva(4,1);"></a>
					    <a class="e2" onclick="javascript:seteva(4,2);"></a>
					    <a class="e3" onclick="javascript:seteva(4,3);"></a>
					    <a class="e4" onclick="javascript:seteva(4,4);"></a>
					    <a class="e5 on" onclick="javascript:seteva(4,5);"></a>
					</p>
				</li>
			</ul>
			<p class="btn_more"><a href="#1">주인장에게 한마디 ▼</a></p>
		</div>

		<div class="d3">
			<h2>주인장에게 한마디 <span>(응모권1개 추가 지급)</span></h2>
			<p class="p2">작성하신 글은 해당업체 대표의 답글이 있으면 공개됩니다. <br>칭찬이나 개선사항을 따뜻한 마음으로 적어주세요.</p>
			<div>
				<textarea name="comment" placeholder="최소 5자 이상 작성해 주세요."></textarea>
			</div>
		</div>
