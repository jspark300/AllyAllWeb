...
$subject = $send_name."님께서 올이올 서비스를 통해 경품을 선물하셨습니다.";
...
<div style='margin:30px auto;width:600px;border:10px solid #f7f7f7'>
    <div style='border:1px solid #dedede'>
        ...
        <p style='margin:20px 0 0;padding:30px 30px 50px;min-height:40px;height:auto !important;height:200px;border-bottom:1px solid #eee'>
			...
			<dd>	
				<p><img src='http://allyall.co.kr/data/item/".$give[img_id]."/".$give[img1]."' alt=''></p>
        ...
        <a href='http://allyall.co.kr/mycoupon_reg.php?cp=".$give[coupon]."' target='_blank' style='display:block;padding:30px 0;margin-bottom:1px;background:#0095fd;color:#fff;text-decoration:none;text-align:center'>쿠폰등록</a>
        
        <a href='http://allyall.co.kr' target='_blank' style='display:block;padding:30px 0;background:#0095fd;color:#fff;text-decoration:none;text-align:center'>ALLYALL 사이트 바로가기</a>
        ...
        <table style='border:0; cellpadding:0; cellspacing:0; border-collapse:collapse; border-spacing:0; width:700px;'>
            <tr>
                <td style='border:#00b6fd solid 1px; background-color:#00b6fd; text-align:center; padding:10px 0 5px 0;'>
                    <img src='http://allyall.co.kr/images/email/logo.png'>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style='border:#00a2de solid 1px; border-top:0; border-bottom:0; padding:20px 20px; text-size:14px; color:#000; line-height:1.5em;'>
                    <div style='padding:10px; background-color:#008aea; color:#fff;'>
						<p  style='text-align:center;'><img src='http://allyall.co.kr/data/item/".$give[img_id]."/".$give[img1]."' alt=''></p>
                        ...
                        · 쿠폰번호 : ".$give[coupon]."
                        <p style='text-align:center; font-size:16px; font-weight:bold; background-color:#ff9933; padding:5px 0;'><a href='http://allyall.co.kr/mycoupon_reg.php?cp=".$give[coupon]."' target='_blank' style='color:#000; text-decoration:none; display:block;'>쿠폰등록 바로가기</a></p>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style='border:#00a2de solid 1px; border-top:0; padding:0;' >
                    <img src='http://allyall.co.kr/images/email//footer.png'>
                </td>
            </tr>         
        </table>
    </body>
