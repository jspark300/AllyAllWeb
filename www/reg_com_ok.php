...
if ($_FILES['img1']['name']) {
   $it_img1 = it_img_upload($_FILES['img1']['tmp_name'],   $_FILES['img1']['name'],$shop_img_dir.'/'.$it_id);
	...
	make_thumbnail($shop_img_dir.'/'.$it_id.'/'.$it_img1,100*2,75*2,$shop_img_dir.'/'.$it_id.'/0.jpg');
	$it_img0 = "0.jpg";

	make_thumbnail($shop_img_dir.'/'.$it_id.'/'.$it_img1,400,300,$shop_img_dir.'/'.$it_id.'/1.jpg');
	$it_img1 = "1.jpg";
...
if ($_FILES['img2']['name']) {
	...
	make_thumbnail($shop_img_dir.'/'.$it_id.'/'.$it_img2,400,300,$shop_img_dir.'/'.$it_id.'/2.jpg');
	$it_img2 = "2.jpg";
}
if ($_FILES['img3']['name']) {
    $it_img3 = it_img_upload($_FILES['img3']['tmp_name'],  $_FILES['img3']['name'],$shop_img_dir.'/'.$it_id);
	$it_img3 = basename($it_img3);
	make_thumbnail($shop_img_dir.'/'.$it_id.'/'.$it_img3,400,300,$shop_img_dir.'/'.$it_id.'/3.jpg');
	$it_img3 = "3.jpg";
}
if ($_FILES['img4']['name']) {
    $it_img4 = it_img_upload($_FILES['img4']['tmp_name'],  $_FILES['img4']['name'],$shop_img_dir.'/'.$it_id);
	$it_img4 = basename($it_img4);
	make_thumbnail($shop_img_dir.'/'.$it_id.'/'.$it_img4,400,300,$shop_img_dir.'/'.$it_id.'/4.jpg');
	$it_img4 = "4.jpg";
}
if ($_FILES['img5']['name']) {
